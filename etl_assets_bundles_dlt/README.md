# etl_assets_bundles_dlt

The 'etl_assets_bundles_dlt' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] etl_assets_bundles_dlt_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/etl_assets_bundles_dlt.job.yml). The schedule
